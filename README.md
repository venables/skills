...
| [swarm-pr-review](./skills/swarm-pr-review)     | Review a PR with a Claude Code swarm: three specialized teammates (correctness, code health, UX) review the diff, discuss with each other, reach consensus, then post a merge verdict plus inline comments on the real issues                                                        |
